...
## Project Idea
Use both human crowd predictions and GPT-based predictions to estimate movie ratings on Douban, then compare:
...
- Compare crowd vs GPT accuracy using MAE  
...
Generate embeddings from each movie’s title/year/summary/genre/actors.  
Use them to:
